...
def home():
    ...
    posts = driver.find_element(By.CSS_SELECTOR, 'div.highlighted-story').find_element(By.CSS_SELECTOR,
                                                                                       'div.colombiaonesuccess').find_elements(
        By.CSS_SELECTOR, 'div')
    ...
    while True:
        ...
        target_post = driver.find_element(By.CSS_SELECTOR, 'div.highlighted-story').find_element(By.CSS_SELECTOR,
                                                                                                 'div.colombiaonesuccess').find_elements(
            By.CSS_SELECTOR, 'div')[0]
